      ...
      <div className="container-fluid p-0">
        <section className="resume-section" id="about">
          <div className="resume-section-content">
            ...
            <hr />
            <p className="lead mb-5">Computer Systems Engineer with experience in Web Development/Wordpress. Passionate about technology and innovation. Always looking to grow.
